...
### Назначение:
Группировка для полей с недискретными (непрерывными) значениями, например:  
 * диапазон цен, 
 * временной интервал,
 * шкала непрерывных значений
 * и т.д.
...
В каждой группе можно получить сразу несколько типов агрегатных значений:
...
### Назначение:
Группировка для полей с дискретными значениями.
...
Когда использовать:
    ...
    $group: Когда поле содержит дискретные значения
